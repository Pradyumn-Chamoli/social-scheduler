...
const Sidebar = ({
  ...
  const navItems = [
    ...
    { name: "Account", icon: UsersIcon, path: "/accounts" },
    ...
    >
      ...
      <div className="border-t border-slate-200 p-4">
        <div className="flex items-center gap-3">
          <div className="size-10 rounded-full bg-gradient-to-br from-pink-500 to-red-400 flex items-center justify-center text-white font-semibold shrink-0">
        ...
        <button
          onClick={logout}
          className="mt-4 flex items-center gap-2 text-sm text-slate-500 hover:text-red-500 transition-colors"
        >
